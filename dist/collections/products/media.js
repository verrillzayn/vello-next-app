...
var isAdminOrAccessToImages = function () {
    return function (_a) {
        var req = _a.req;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(referer === null || referer === void 0 ? void 0 : referer.includes("sell")) || !req.user) {
                                return [2 /*return*/, true];
                            }
                            return [4 /*yield*/, isAdminOrAccessToImages()({ req: req })];
